...
public interface UserAccount {
    ...
    public default List<String> validate() {
        ...
        // Add more username-specific validations if needed
        
        // Validate Email (Optional)
        if(getUserEmail() != null && !getUserEmail().trim().isEmpty()) {
            if(getUserEmail().length() > 128) {
                errors.add("Email cannot be greater than 128 characters.");
            }
    ...
    /* Static method to determine if a password is valid. The rules here ensure that
